...
tt.powers.burst.price_base = 250
...
tt.ranged.attacks[1].max_shots = 15
...
tt.powers.pestilence.price_base = 200
...
tt.hero.skills.callofwild.hp_base = 200
...
tt.ranged.attacks[1].max_range = 145
tt.ranged.attacks[1].min_range = 60
tt.ranged.attacks[1].damage_type = DAMAGE_MAGICAL
tt.ranged.attacks[1].shoot_time = fts(9)
tt.render.sprites[1].anchor = v(anchor_x, anchor_y)
...
tt.timed_attacks.list[1].damage_type = DAMAGE_MAGICAL
