return {
	holder = {
		{
			...
			{
				check = "main_icons_0019",
				action_arg = "tower_build_elven_barrack",
				action = "tw_upgrade",
				halo = "glow_ico_main",
				image = "main_icons_0015",
				place = 5,
				preview = "elven_barrack",
				tt_title = _("TOWER_ELVEN_BARRACK_1_NAME"),
				tt_desc = _("TOWER_ELVEN_BARRACK_1_DESCRIPTION")
			}		 
		}
	},
	...
	mage = {
		...
		},
		{
			...
			},
			{
				...
				action = "tw_upgrade",
				halo = "glow_ico_main",
				image = "main_icons_2032",
				place = 10,
				tt_title = _("TOWER_ELDRITCH_MAGE_WILD_MAGUS_NAME"),
				tt_desc = _("TOWER_ELDRITCH_MAGE_WILD_MAGUS_DESCRIPTION")
			},
			{
				check = "main_icons_0019",
				action_arg = "tower_mage_1_a",
				action = "tw_upgrade",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 5,
			...
			},
			{
				...
				action = "tw_upgrade",
				halo = "glow_ico_main",
				image = "main_icons_2031",
				place = 11,
				tt_title = _("TOWER_ELDRITCH_MAGE_HIGH_ELVEN_NAME"),
				tt_desc = _("TOWER_ELDRITCH_MAGE_HIGH_ELVEN_DESCRIPTION")
			},
			{
				check = "ico_sell_0002",
				action = "tw_sell",
	...
	tower_mage_1_a = {
			...
			{
				check = "main_icons_0019",
				action_arg = "tower_sunray_mini",
				action = "tw_upgrade",
				halo = "glow_ico_main",
				image = "main_icons_0823",
				place = 2,
				tt_title = _("SPECIAL_SUNRAY_NAME"),
				tt_desc = _("SPECIAL_SUNRAY_DESCRIPTION")
			},
			{
				check = "ico_sell_0002",
				action = "tw_sell",
	...
	neptune = {
		{
			{
				check = "main_icons_0019",
				action_arg = "tower_sorcerer_cheat",
				action = "tw_upgrade",
				halo = "glow_ico_main",
				image = "main_icons_0026",
				place = 5,
	...
	eldritch_mage = {
		{
			{
				check = "main_icons_0019",
				action_arg = "tower_eldritch_mage_2",
				action = "tw_upgrade",
				halo = "glow_ico_main",
				image = "main_icons_0040",
				place = 5,
				tt_title = _("TOWER_ELDRITCH_MAGE_2_NAME"),
				tt_desc = _("TOWER_ELDRITCH_MAGE_2_DESCRIPTION")
			},
			{
				check = "ico_sell_0002",
				action = "tw_sell",
		...
		},
		{
			{
				check = "main_icons_0019",
				action_arg = "tower_eldritch_mage_3",
				action = "tw_upgrade",
				halo = "glow_ico_main",
				image = "main_icons_0040",
				place = 5,
				tt_title = _("TOWER_ELDRITCH_MAGE_3_NAME"),
				tt_desc = _("TOWER_ELDRITCH_MAGE_3_DESCRIPTION")
			},
			{
				check = "ico_sell_0002",
				action = "tw_sell",
	...
	tree_archer = {
		{
			{
				check = "main_icons_0019",
				action_arg = "tower_tree_archer_2",
				action = "tw_upgrade",
				halo = "glow_ico_main",
				image = "main_icons_0040",
				place = 5,
				tt_title = _("TOWER_TREE_ARCHER_2_NAME"),
				tt_desc = _("TOWER_TREE_ARCHER_2_DESCRIPTION")
			},
			{
				check = "ico_sell_0002",
				action = "tw_sell",
		...
		},
		{
			{
				check = "main_icons_0019",
				action_arg = "tower_tree_archer_3",
				action = "tw_upgrade",
				halo = "glow_ico_main",
				image = "main_icons_0040",
				place = 5,
				tt_title = _("TOWER_TREE_ARCHER_3_NAME"),
				tt_desc = _("TOWER_TREE_ARCHER_3_DESCRIPTION")
			},
			{
				check = "ico_sell_0002",
				action = "tw_sell",
	...
	elven_barrack = {
		{
			{
				check = "main_icons_0019",
				action_arg = "tower_elven_barrack_2",
				action = "tw_upgrade",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 5,
				tt_title = _("TOWER_ELVEN_BARRACK_2_NAME"),
				tt_desc = _("TOWER_ELVEN_BARRACK_2_DESCRIPTION")
			},
			{
				halo = "glow_ico_sub",
				image = "sub_icons_0001",
		...
		},
		{
			{
				check = "main_icons_0019",
				action_arg = "tower_elven_barrack_3",
				action = "tw_upgrade",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 5,
				tt_title = _("TOWER_ELVEN_BARRACK_3_NAME"),
				tt_desc = _("TOWER_ELVEN_BARRACK_3_DESCRIPTION")
			},
			{
				halo = "glow_ico_sub",
				image = "sub_icons_0001",
		...
		},
		{
			...
			{
				check = "main_icons_0019",
				action_arg = "tower_barrack_pirates_w_flamer",
				action = "tw_upgrade",
				halo = "glow_ico_main",
			...
			{
				check = "main_icons_0019",
				action_arg = "tower_elven_barrack_1_s",
				action = "tw_upgrade",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 5,
				tt_title = _("TOWER_NEXT_PAGE_SPECIAL_NAME"),
				tt_desc = _("TOWER_NEXT_PAGE_SPECIAL_DESCRIPTION")
			},
			{
				halo = "glow_ico_sub",
				image = "sub_icons_0001",
	...
	tower_archer_1_b = {
		{
			...
			{
				check = "main_icons_0019",
				action_arg = "tower_archer_hammerhold",
				action = "tw_upgrade",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 3,
	...
	tower_elven_barrack_1_s = {
		{
			{
				check = "main_icons_0019",
				action_arg = "tower_elven_barrack_1_b",
				action = "tw_upgrade",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 5,
	...
	tower_elven_barrack_1_b = {
		{
			...
			},
			{
				...
				image = "main_icons_0005",
				place = 5,
				tt_title = _("TOWER_NEXT_PAGE_SPECIAL_TWO_NAME"),
				tt_desc = _("TOWER_NEXT_PAGE_SPECIAL_TWO_DESCRIPTION")
			},
			{
				check = "sub_icons_0003",
				action = "tw_rally",
	...
	dragon = {
		{
			{
				check = "main_icons_0019",
				action_arg = "Soldier_PotbelliedDemon",
				action = "tw_buy_soldier",
				halo = "glow_ico_main",
				image = "main_icons_0017",
				place = 5,
				tt_title = _("SPECIAL_SASQUASH126_NAME"),
				tt_desc = _("SPECIAL_SASQUASH5_DESCRIPTION")
			},
			{
				halo = "glow_ico_sub",
				image = "sub_icons_0001",
	...
	gelf = {
		{
			{
				check = "main_icons_0019",
				action_arg = "soldier_Gelf",
				action = "tw_buy_soldier",
				halo = "glow_ico_main",
				image = "main_icons_0017",
				place = 1,
				tt_title = _("SPECIAL_SASQUASH124_NAME"),
				tt_desc = _("SPECIAL_SASQUASH3_DESCRIPTION")
			},
			{
				check = "main_icons_0019",
				action_arg = "Soldier_FlareBomber",
				action = "tw_buy_soldier",
				halo = "glow_ico_main",
				image = "main_icons_0017",
				place = 2,
				tt_title = _("SPECIAL_SASQUASH128_NAME"),
				tt_desc = _("SPECIAL_SASQUASH7_DESCRIPTION")
			},
			{
				halo = "glow_ico_sub",
				image = "sub_icons_0001",
	...
	betrayerbig2 = {
		{
			{
				check = "main_icons_0019",
				action_arg = "soldier_troll_brute",
				action = "tw_buy_soldier",
				halo = "glow_ico_main",
				image = "main_icons_0017",
				place = 5,
				tt_title = _("SPECIAL_SASQUASH667_NAME"),
				tt_desc = _("SPECIAL_SASQUASH1_DESCRIPTION")
			},
			{
				halo = "glow_ico_sub",
				image = "sub_icons_0001",
	...
	betrayer2 = {
		{
			{
				check = "main_icons_0019",
				action_arg = "soldier_goblin_zapper",
				action = "tw_buy_soldier",
				halo = "glow_ico_main",
				image = "main_icons_0017",
				place = 5,
				tt_title = _("SPECIAL_SASQUASH4_NAME"),
				tt_desc = _("SPECIAL_SASQUASH1_DESCRIPTION")
			},
			{
				check = "main_icons_0019",
				action_arg = "soldier_orc_armored",
				action = "tw_buy_soldier",
				halo = "glow_ico_main",
				image = "main_icons_0017",
				place = 1,
				tt_title = _("SPECIAL_SASQUASH5_NAME"),
				tt_desc = _("SPECIAL_SASQUASH1_DESCRIPTION")
			},
			{
				check = "main_icons_0019",
				action_arg = "soldier_orc_rider",
				action = "tw_buy_soldier",
				halo = "glow_ico_main",
				image = "main_icons_0017",
				place = 2,
				tt_title = _("SPECIAL_SASQUASH6_NAME"),
				tt_desc = _("SPECIAL_SASQUASH1_DESCRIPTION")
			},
			{
				halo = "glow_ico_sub",
	...
	betrayer3 = {
		{
			{
				check = "main_icons_0019",
				action_arg = "soldier_troll_axe_thrower",
				action = "tw_buy_soldier",
				halo = "glow_ico_main",
				image = "main_icons_0017",
				place = 5,
				tt_title = _("SPECIAL_SASQUASH7_NAME"),
				tt_desc = _("SPECIAL_SASQUASH1_DESCRIPTION")
			},
			{
				check = "main_icons_0019",
				action_arg = "soldier_troll",
				action = "tw_buy_soldier",
				halo = "glow_ico_main",
				image = "main_icons_0017",
				place = 1,
				tt_title = _("SPECIAL_SASQUASH8_NAME"),
				tt_desc = _("SPECIAL_SASQUASH1_DESCRIPTION")
			},
			{
				check = "main_icons_0019",
				action_arg = "soldier_troll_skater",
				action = "tw_buy_soldier",
				halo = "glow_ico_main",
				image = "main_icons_0017",
				place = 2,
				tt_title = _("SPECIAL_SASQUASH9_NAME"),
				tt_desc = _("SPECIAL_SASQUASH1_DESCRIPTION")
			},
			{
				halo = "glow_ico_sub",
